...
#knit a GIS map/interactive map into html so that you dont run into problems
```
...
UPNE <- st_read('./Data/Spatial/NCHUC8.shp') %>%
...
ggplot() +
  ...
  geom_sf(data=neuse_sf, fill= 'orange', color = 'black') +

  mapview(huc8_sf, col.regions='orange', alpha=1)
